...
Ltac solve_lc_bexpr :=
  repeat
    match goal with
    | _ : _ |- lc_bexpr (ae_abs ?e1 ?e2)  => inst_cofinites_with_new; eapply lc_be_abs_exists; intuition; eauto;
                                             econstructor; fold open_expr_wrt_expr_rec; intuition; eauto
    | _ : _ |- lc_bexpr (ae_pi ?e1 ?e2)   => inst_cofinites_with_new; eapply lc_be_pi_exists; intuition; eauto
    end.
*)
